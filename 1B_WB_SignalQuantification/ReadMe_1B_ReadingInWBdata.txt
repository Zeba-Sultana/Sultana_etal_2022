...
- WB_DATA_ReadIn.R : The script used to read in the quantification values from xls files that I manually exported form Odyssey image quantification and TPS quantification.    
...
- OUTPUT : The WB signals, along with their normalisation over GAPDH(GNorm) and over Total protein stain(TNorm) and associated annotations are written out as xls files in the folder "OUTPUT". TNorm was found to be better and hence that was used going forward
