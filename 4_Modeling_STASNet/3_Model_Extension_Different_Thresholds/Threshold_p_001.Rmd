---
title: "Best %residual, pvalue < 0.001 "
author: ""
date: ''
output:  
  html_document:
...
source("./U_FUNCTIONS/Script_LinkSelection_4_ModelExtension_Pvalue_001.R")
Modeling_Dir = "/Users/sultana/PHD_PROJECT_Zeba/ANALYSIS_WORKFLOW_Oct2020_Model_MPIServer/Perc_DelRes_Lowestpvalue_001_20201021" 

#Modeling_Dir = "/project/ag_schulz/Zeba/MODELING_STASNet/Perc_DelRes_Lowestpvalue_001_20201021"
...
3.) Retain only links that have adjusted **p-value < 0.001** and value !=0      
...
Init_XX_FC_Model_Folder = "XX/run_XX_R345_Network_100k_2020-10-21" #Current_Model_Folder
...
LA1_XX_FC_Model_Folder = "XX/run_XX_R345_Network_LA1_100k_2020-10-21" #Current_Model_Folder
...
LA2_XX_FC_Model_Folder = "XX/run_XX_R345_Network_LA2_100k_2020-10-21" #Current_Model_Folder
...
LA3_XX_FC_Model_Folder = "XX/run_XX_R345_Network_LA3_100k_2020-10-21" #Current_Model_Folder
...
LA4_XX_FC_Model_Folder = "XX/run_XX_R345_Network_LA4_100k_2020-10-22" #Current_Model_Folder
...
LA5_XX_FC_Model_Folder = "XX/run_XX_R345_Network_LA5_100k_2020-10-22" #Current_Model_Folder
...
LA6_XX_FC_Model_Folder = "XX/run_XX_R345_Network_LA6_100k_2020-10-22" #Current_Model_Folder
...
LA7_XX_FC_Model_Folder = "XX/run_XX_R345_Network_LA7_100k_2020-10-22" #Current_Model_Folder
...
Init_XO_FC_Model_Folder = "XO/run_XO_R345_Network_100k_2020-10-21" #Current_Model_Folder
...
LA1_XO_FC_Model_Folder = "XO/run_XO_R345_Network_LA1_100k_2020-10-21" #Current_Model_Folder
...
LA2_XO_FC_Model_Folder = "XO/run_XO_R345_Network_LA2_100k_2020-10-21" #Current_Model_Folder
...
LA3_XO_FC_Model_Folder = "XO/run_XO_R345_Network_LA3_100k_2020-10-21" #Current_Model_Folder
...
LA4_XO_FC_Model_Folder = "XO/run_XO_R345_Network_LA4_100k_2020-10-22" #Current_Model_Folder
...
LA5_XO_FC_Model_Folder = "XO/run_XO_R345_Network_LA5_100k_2020-10-22" #Current_Model_Folder
...
LA6_XO_FC_Model_Folder = "XO/run_XO_R345_Network_LA6_100k_2020-10-22" #Current_Model_Folder
...
LA7_XO_FC_Model_Folder = "XO/run_XO_R345_Network_LA7_100k_2020-10-22" #Current_Model_Folder
...
Final_Network_file <- "XX/Network_LA7.tab"
...
Model_iteration=c("Init","1","2","3","4","5","6","7")
Model_iteration = factor(Model_iteration, levels =Model_iteration )

LinksAdded_p_001<- data.frame(Iteration=Model_iteration,Links=c("Init Network",New_links$Link))
...
res_p_001_XX = c(Init_XX_FC_model$bestfit,
...
res_p_001_XO = c(Init_XO_FC_model$bestfit,
...
Links_Residuals_p_001 <- data.frame(Model_iteration,Links=c("Init Network",New_links$Link),res_p_001_XX,res_p_001_XO)
Links_Residuals_p_001 <- Links_Residuals_p_001 %>% 
  dplyr::mutate(res_p_001_XX=round(res_p_001_XX,2),
                res_p_001_XO=round(res_p_001_XO,2))
write.csv(Links_Residuals_p_001, "Links_Residuals_p_001.csv")

PrintOut_Table(Links_Residuals_p_001)


Res_p_001_long <- Links_Residuals_p_001 %>% 
  pivot_longer(grep("res",colnames(Links_Residuals_p_001)),names_to = "Model", values_to = "residual")
...
p <- ggplot(Res_p_001_long, aes(x=Model_iteration, y=residual, color=Model, group=Model))+
  MyHTMLTheme+
  geom_point(size=4)+
  geom_line(size=1.5)+
