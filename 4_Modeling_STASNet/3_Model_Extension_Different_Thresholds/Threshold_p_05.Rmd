---
title: "Best %residual, pvalue < 0.05 "
author: ""
date: ''
output:  
  html_document: 
...
source("./U_FUNCTIONS/Script_LinkSelection_4_ModelExtension_Pvalue_05.R")
Modeling_Dir = "/Users/sultana/PHD_PROJECT_Zeba/ANALYSIS_WORKFLOW_Oct2020_Model_MPIServer/Perc_DelRes_Highestpvalue_05_20201020" 
#Modeling_Dir = "/project/ag_schulz/Zeba/MODELING_STASNet/Perc_DelRes_Highestpvalue_05_20201020"
...
3.) Retain only links that have adjusted **p-value < 0.05** and value !=0      
...
Init_XX_FC_Model_Folder = "XX/run_XX_R345_Network_100k_2020-10-20" #Current_Model_Folder
...
LA1_XX_FC_Model_Folder = "XX/run_XX_R345_Network_LA1_100k_2020-10-20" #Current_Model_Folder
...
LA2_XX_FC_Model_Folder = "XX/run_XX_R345_Network_LA2_100k_2020-10-20" #Current_Model_Folder
...
LA3_XX_FC_Model_Folder = "XX/run_XX_R345_Network_LA3_100k_2020-10-20" #Current_Model_Folder
...
LA4_XX_FC_Model_Folder = "XX/run_XX_R345_Network_LA4_100k_2020-10-21" #Current_Model_Folder
...
LA5_XX_FC_Model_Folder = "XX/run_XX_R345_Network_LA5_100k_2020-10-21" #Current_Model_Folder
...
LA6_XX_FC_Model_Folder = "XX/run_XX_R345_Network_LA6_100k_2020-10-21" #Current_Model_Folder
...
LA7_XX_FC_Model_Folder = "XX/run_XX_R345_Network_LA7_100k_2020-10-21" #Current_Model_Folder
...
LA8_XX_FC_Model_Folder = "XX/run_XX_R345_Network_LA8_100k_2020-10-21" #Current_Model_Folder
...
LA9_XX_FC_Model_Folder = "XX/run_XX_R345_Network_LA9_100k_2020-10-21" #Current_Model_Folder
...
LA10_XX_FC_Model_Folder = "XX/run_XX_R345_Network_LA10_100k_2020-10-22" #Current_Model_Folder
...
Init_XO_FC_Model_Folder = "XO/run_XO_R345_Network_100k_2020-10-20" #Current_Model_Folder
...
LA1_XO_FC_Model_Folder = "XO/run_XO_R345_Network_LA1_100k_2020-10-20" #Current_Model_Folder
...
LA2_XO_FC_Model_Folder = "XO/run_XO_R345_Network_LA2_100k_2020-10-20" #Current_Model_Folder
...
LA3_XO_FC_Model_Folder = "XO/run_XO_R345_Network_LA3_100k_2020-10-20" #Current_Model_Folder
...
LA4_XO_FC_Model_Folder = "XO/run_XO_R345_Network_LA4_100k_2020-10-21" #Current_Model_Folder
...
LA5_XO_FC_Model_Folder = "XO/run_XO_R345_Network_LA5_100k_2020-10-21" #Current_Model_Folder
...
LA6_XO_FC_Model_Folder = "XO/run_XO_R345_Network_LA6_100k_2020-10-21" #Current_Model_Folder
...
LA7_XO_FC_Model_Folder = "XO/run_XO_R345_Network_LA7_100k_2020-10-21" #Current_Model_Folder
...
LA8_XO_FC_Model_Folder = "XO/run_XO_R345_Network_LA8_100k_2020-10-21" #Current_Model_Folder
...
LA9_XO_FC_Model_Folder = "XO/run_XO_R345_Network_LA9_100k_2020-10-21" #Current_Model_Folder
...
LA10_XO_FC_Model_Folder = "XO/run_XO_R345_Network_LA10_100k_2020-10-22" #Current_Model_Folder
...
LinksAdded_p_05<- data.frame(Iteration=Model_iteration,Links=c("Init Network",New_links$Link))
...
res_p_05_XX = c(Init_XX_FC_model$bestfit,
...
res_p_05_XO = c(Init_XO_FC_model$bestfit,
...
Links_Residuals_p_05 <- data.frame(Model_iteration,Links=c("Init Network",New_links$Link),res_p_05_XX,res_p_05_XO)
Links_Residuals_p_05 <- Links_Residuals_p_05 %>% 
  dplyr::mutate(res_p_05_XX=round(res_p_05_XX,2),
                res_p_05_XO=round(res_p_05_XO,2))
write.csv(Links_Residuals_p_05, "Links_Residuals_p_05.csv")

PrintOut_Table(Links_Residuals_p_05)


Res_p_05_long <- Links_Residuals_p_05 %>% 
  pivot_longer(grep("res",colnames(Links_Residuals_p_05)),names_to = "Model", values_to = "residual")
...
p <- ggplot(Res_p_05_long, aes(x=Model_iteration, y=residual, color=Model, group=Model))+
  MyHTMLTheme+
  geom_point(size=4)+
  geom_line(size=1.5)+
