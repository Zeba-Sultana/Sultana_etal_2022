...
In Case of XOR4 two following treatments did not seem correct for Akt :
Fgf4+Meki and Bmp4ri+Gsk3i. Hence, I replaced the Akt reading for these two treatments in XOR4 with NA. 
...
4.) Fold Change over control used as input to STASNet is saved at : ./OUTPUT
Bioplex_FC_STASNet.xls is used as input to STASNet
